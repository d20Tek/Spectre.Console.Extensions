...
internal class FakeConfigurator<TSettings>(CommandMetadata command, ITypeRegistrar? registrar) : IConfigurator<TSettings>
    where TSettings : CommandSettings
{
    private readonly CommandMetadata _command = command;
    private readonly ITypeRegistrar? _registrar = registrar;

    public void SetDescription(string description) => _command.Description = description;

    public void AddExample(string[] args) => _command.Examples.Add(args);

    public void HideBranch() => _command.IsHidden = true;
