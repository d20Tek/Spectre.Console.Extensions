...
public class CommandAppTestContext
{
    ...
    private readonly TestCommandInterceptor _commandIntercept;
    ...
    public async Task<CommandAppResult> RunAsync(string[] args)
    {
        ...
        return new CommandAppResult(
            exitCode,
            Console.Output,
            _commandIntercept.Context,
            _commandIntercept.Settings);
    }
        ...
        where T : Exception
    {
        ...
        catch (T ex)
        {
            ...
            return new CommandAppResult(-1, Console.Output, _commandIntercept.Context, _commandIntercept.Settings);
        }
        catch (Exception ex)
        {
    ...
    private CommandApp CreateConfiguredApp(bool propagateExceptions = false)
    {
        ...
        if (_configureAction != null) app.Configure(_configureAction);
        ...
        app.Configure(c =>
        {
            ...
            if (propagateExceptions) c.PropagateExceptions();
        });
