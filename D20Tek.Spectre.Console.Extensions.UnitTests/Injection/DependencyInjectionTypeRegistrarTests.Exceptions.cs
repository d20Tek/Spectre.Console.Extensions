...
namespace D20Tek.Spectre.Console.Extensions.UnitTests.Injection
{
    ...
    public class DependencyInjectionTypeRegistrarExceptionTests
    {
...
#pragma warning disable CS8625 // Cannot convert null literal to non-nullable reference type.
        [TestMethod]
        public void Create_WithNullServiceCollection()
        {
            // arrange

            // act
            Assert.ThrowsExactly<ArgumentNullException>(() => new DependencyInjectionTypeRegistrar(null));
        }
